...
class AttackDefenseEnv(gym.Env):
    ...
    def __init__(
        ...
        self._simulator = WorldSimulator(self._dynamics, self._defender_policy, cfg)
    ...
    def step(self, action: np.ndarray):
        ...
        reward_breakdown = self._reward.compute(prev_world, next_world, events, action, termination_result.reason)
